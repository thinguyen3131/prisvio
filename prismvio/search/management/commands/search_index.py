...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--create", action="store_const", dest="action", const="create", help="Create the indices in elasticsearch"
        )
        parser.add_argument(
            "--populate",
            action="store_const",
        ...
        parser.add_argument(
            "--delete", action="store_const", dest="action", const="delete", help="Delete the indices in elasticsearch"
        )
        parser.add_argument(
            "--rebuild",
            action="store_const",
    ...
    def _delete(self, models, aliases, options):
        ...
        if not options["force"]:
            response = input(
                "Are you sure you want to delete " "the '{}' indices? [y/N]: ".format(", ".join(index_names))
            )
            if response.lower() != "y":
