    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "avatar",
                    models.JSONField(blank=True, default=dict, help_text="Avatar of merchant vio app", null=True),
                ),
                ("deleted_at", models.DateTimeField(blank=True, null=True)),
                ...
                ("hashtags", models.ManyToManyField(blank=True, related_name="merchants", to="menu_merchant.hashtag")),
                ("keywords", models.ManyToManyField(blank=True, related_name="merchants", to="menu_merchant.keyword")),
            ],
        ),
        migrations.CreateModel(
