...
from prismvio.system.enum import EmailTemplateLanguage
...
class EmailTemplate(models.Model):
    ...
    language = models.CharField(
        max_length=100, null=False, choices=EmailTemplateLanguage.choices, default=EmailTemplateLanguage.ENG
    )
