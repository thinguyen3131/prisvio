    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invite_status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Accepted', 'Accepted')], default=None, max_length=50, null=True)),
                ('link_status', models.CharField(blank=True, choices=[('Unlinked', 'Unlinked'), ('Linked', 'Linked')], default='Unlinked', max_length=50, null=True)),
                ...
                ('merchant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staff', to='merchant.merchant')),
