...
from prism.utils.drf_utils import handle_whitespace
from staffs.api.serializers import (CancelInviteSerializer, LinkToStaffSerializer, StaffAcceptedInviteSerializer,
                                   StaffSerializer, UnlinkStaffSerializer)
from staffs.constants import STAFF_SORT_FIELDS
from staffs.enums import InviteStatusEnum, LinkStatusEnum
from staffs.exceptions import StaffDoesNotExists
from staffs.models import Staff
from users.api.serializers import EmailPhoneLookupSerializer, UserDetailSerializer
from users.models import User
from users.tasks import invite_new_user
...
class InviteStaffAPI(APIView):
    def post(self, request, *args, **kwargs):
        ...
        Staff.objects.filter(email__in=emails).update(
            invite_status=InviteStatusEnum.PENDING.value,
            link_status=LinkStatusEnum.UNLINKED.value)
