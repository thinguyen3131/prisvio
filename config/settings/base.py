...
MIGRATION_MODULES = {"sites": "prismvio.contrib.sites.migrations"}
...
ADMINS = [("""PrismVio""", "prismvio@prismtech.vn")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "PrismVio API",
    "DESCRIPTION": "Documentation of API endpoints of PrismVio",
    "VERSION": "1.0.0",
...
DRF_EXCEPTION_IMPORT_STRINGS = ("EXCEPTION_REPORTING",)

DRF_EXCEPTION: APISettings = APISettings(
    DRF_EXCEPTION_USER_SETTINGS, DRF_EXCEPTION_DEFAULTS, DRF_EXCEPTION_IMPORT_STRINGS
)

TESTING: bool = env.bool(
    "TESTING",
    default=False,
)
