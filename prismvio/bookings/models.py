...
class Booking(models.Model):
    ...
    products = models.ManyToManyField(Product, blank=True, related_name="products", through="BookingProduct")
    services = models.ManyToManyField(Service, blank=True, related_name="services", through="BookingService")
