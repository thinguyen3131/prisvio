...
from prismvio.menu_merchant.models import Category, Hashtag, Keyword, Product
...
class ProductsDocument(Document):
    ...
    def get_instances_from_related(self, related_instance):
        if isinstance(related_instance, Hashtag):
            return related_instance.products.get_with_related_data().all()
...
class ProductSearch(Search):
    ...
    def custom_search(self, queryset, request: ProductSearchRequest):
        must = [
