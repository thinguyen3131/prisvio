...
from booking.enums import BookingStatusEnum, PaymentMethodEnum


class Booking(models.Model):

    merchant = models.ForeignKey(Merchant, on_delete=models.CASCADE, null=True, blank=True)
    booked_user = models.ForeignKey(settings.AUTH_USER_MODEL,
    ...
    cancel_by = models.ForeignKey(settings.AUTH_USER_MODEL,
                                    on_delete=models.SET_NULL,
                                    null=True,
                                    blank=True,
                                    default=None)
